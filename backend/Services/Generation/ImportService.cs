...
public sealed class ImportService(IGrainFactory grains, ILogger<ImportService> logger)
{
        ...
        CancellationToken cancellationToken)
    {
        var messages = new List<LlmChatMessage>
        {
            ...
            new() { Role = "user", Content = ImportPrompts.PersonaExtractionUser(systemInstructionText) }
        };
        ...
        {
            logger.LogWarning("Persona extraction returned empty. Falling back to single Narrator stub.");
