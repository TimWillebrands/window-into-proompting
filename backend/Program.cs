...
using PartyTown.Services.Graph;
...
builder.AddNpgsqlDbContext<GraphDbContext>(
    "Default",
    configureDbContextOptions: opts => opts.AddInterceptors(new AgeConnectionInterceptor()));
